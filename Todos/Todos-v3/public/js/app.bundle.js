...
(function () {
  ...
  var lastTodoId = function lastTodoId() {
  ...
  var addTodo = function addTodo() {
    ...
    if (!todos || todos.length == 0) {
      ...
      todo = { id: lastTodoId(), content: content, completed: false };
  ...
  var toggleTodoComplete = function toggleTodoComplete(id) {
    ...
    _axios2.default.patch('/todos/' + id, { completed: !todo.completed }).then(function (res) {
